/**
 * insert_westpoint_batch6_ovens_microwaves_misc.mjs
 * Oven Toasters, Microwaves, Hot Plates, Rice Cookers, Vacuum Cleaners,
 * Toasters, Citrus Juicers, Fan Heaters, Kettles (new models not yet in DB)
...
const PRODUCTS = [
  // ── Oven Toasters ─────────────────────────────────────────────────────────────
  {
    ...
    tags: 'westpoint, WF-1064EX, oven toaster, countertop oven, toaster oven, westpoint oven, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-1065EX', mrp: 13275, cat: 'kitchen', sub: 'Oven Toaster',
    simplified_name: 'Westpoint Oven Toaster with BBQ Grill',
    description: 'The Westpoint WF-1065EX Oven Toaster with BBQ Grill adds a grilling function to the standard toaster oven, letting you prepare grilled meats, vegetables and kebabs at home. The rotisserie-style grill element browns food evenly on all sides. Multiple functions — toast, bake, grill — in one compact appliance. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-1065EX, oven toaster, BBQ grill, countertop oven, westpoint oven, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-1070', mrp: 18250, cat: 'kitchen', sub: 'Oven Toaster',
    simplified_name: 'Westpoint Oven Toaster with BBQ Grill 22L',
    description: 'The Westpoint WF-1070 is a large 22-litre oven toaster with a full BBQ grill function. The spacious interior accommodates a whole chicken, a large pizza or multiple racks of baked goods. The dual heating elements (top and bottom) ensure even heat distribution throughout the cooking chamber. A versatile full-function countertop oven for larger families. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-1070, oven toaster, 22 litre, BBQ grill, large oven, westpoint oven, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-3069TT', mrp: 19150, cat: 'kitchen', sub: 'Oven Toaster',
    simplified_name: 'Westpoint Convection Oven with BBQ Grill',
    description: 'The Westpoint WF-3069TT Convection Oven with BBQ Grill adds a fan-forced convection system to accelerate cooking and ensure perfectly even results throughout the oven. Convection baking reduces cooking times by up to 25% and eliminates hot spots for consistently golden results. The BBQ grill element adds grilling capability. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-3069TT, convection oven, BBQ grill, countertop oven, westpoint oven, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-3075', mrp: 22600, cat: 'kitchen', sub: 'Oven Toaster',
    simplified_name: 'Westpoint Digital Oven with Fan & BBQ Grill',
    description: 'The Westpoint WF-3075 Digital Oven combines fan-forced convection, a digital display and BBQ grill for a premium countertop cooking experience. The digital panel allows precise temperature setting and displays the remaining cooking time accurately. Fan-forced heat circulation ensures evenly cooked results on every rack level. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-3075, digital oven, convection oven, BBQ grill, fan oven, westpoint oven, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-3079', mrp: 27600, cat: 'kitchen', sub: 'Oven Toaster',
    simplified_name: 'Westpoint Oven Toaster BBQ Grill Rotisserie',
    description: 'The Westpoint WF-3079 is a full-featured countertop oven with a rotisserie function that self-bastes whole chickens, roasts and kebab skewers as they rotate. The BBQ grill element adds an authentic chargrilled finish. Multiple cooking functions and a large capacity make this an all-in-one cooking solution. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-3079, oven toaster, rotisserie, BBQ grill, chicken roaster, westpoint oven, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-3080', mrp: 29000, cat: 'kitchen', sub: 'Oven Toaster',
    simplified_name: 'Westpoint Digital Oven Fan & BBQ Grill Rotisserie',
    description: 'The Westpoint WF-3080 is Westpoint\'s flagship countertop oven — combining digital precision, fan-forced convection, BBQ grill and a rotisserie function in one premium appliance. The digital display provides accurate temperature and timer control. Fan convection ensures even heat distribution, while the rotisserie delivers self-basting whole-bird roasting. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-3080, digital oven, rotisserie, convection, BBQ grill, premium oven, westpoint oven, karachi, installment, reliance appliances',
  },

  // ── Microwaves ────────────────────────────────────────────────────────────────
  {
    model: 'WF-9028', mrp: 18300, cat: 'microwave-solo', sub: 'Solo Microwave',
    simplified_name: 'Westpoint Microwave Oven 20L Manual',
    description: 'The Westpoint WF-9028 is a 20-litre manual microwave oven for everyday heating, defrosting and basic cooking tasks. The simple rotary knob controls make it easy to set cooking time and power level without the complexity of digital menus. Compact dimensions suit apartments and smaller kitchens. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-9028, microwave, microwave oven, solo microwave, 20 litre, manual microwave, westpoint microwave, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-9029', mrp: 18350, cat: 'microwave-solo', sub: 'Solo Microwave',
    simplified_name: 'Westpoint Microwave Oven 20L',
    description: 'The Westpoint WF-9029 Microwave Oven provides reliable everyday microwave cooking in a compact 20-litre capacity. Heat leftovers, defrost frozen food and cook simple meals with ease. The rotating glass turntable ensures even heating throughout the food, eliminating cold spots. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-9029, microwave, microwave oven, solo microwave, 20 litre, westpoint microwave, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-9031', mrp: 27650, cat: 'microwave-solo', sub: 'Solo Microwave',
    simplified_name: 'Westpoint Microwave Oven 25L Digital',
    description: 'The Westpoint WF-9031 Digital Microwave Oven offers precise cooking control through a digital display and touch controls. The 25-litre capacity accommodates larger dishes and casseroles. Multiple power levels, auto-cook programs and a digital timer make cooking convenient and consistent. The child-lock function adds safety in family homes. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-9031, microwave, digital microwave, 25 litre, solo microwave, westpoint microwave, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-9039', mrp: 31050, cat: 'microwave-convection', sub: 'Microwave with Oven',
    simplified_name: 'Westpoint Microwave with Oven 30L Digital',
    description: 'The Westpoint WF-9039 is a 30-litre combination microwave and oven that handles both microwave heating and convection baking. Use microwave mode for fast reheating and defrosting, oven mode for baking cakes and grilling, or combine both for faster cooking with better browning. The digital display and preset programs make operation intuitive. A true all-in-one cooking appliance. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-9039, microwave with oven, combination microwave, convection microwave, 30 litre, westpoint microwave, karachi, installment, reliance appliances',
  },

  // ── Hot Plates & Induction ───────────────────────────────────────────────────
  {
    model: 'WF-2061', mrp: 6700, cat: 'kitchen', sub: 'Hot Plate',
    simplified_name: 'Westpoint Hot Plate Single 1500W',
    description: 'The Westpoint WF-2061 Single Hot Plate is a portable electric cooking surface for homes with limited space, outdoor use, or as an extra cooking ring. The 1500W coil element heats up quickly and provides consistent, adjustable heat for all types of cooking vessels. Simple dial control. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-2061, hot plate, electric stove, single burner, portable cooker, westpoint hot plate, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-2062', mrp: 9650, cat: 'kitchen', sub: 'Hot Plate',
    simplified_name: 'Westpoint Hot Plate Double',
    description: 'The Westpoint WF-2062 Double Hot Plate provides two independent cooking elements for simultaneous cooking — perfect for preparing rice and curry at the same time. Each element has its own heat control dial. Sturdy, portable and easy to use as a primary or secondary cooking solution. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-2062, hot plate, double burner, electric stove, two burner, westpoint hot plate, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-2174', mrp: 11200, cat: 'kitchen', sub: 'Induction Cooker',
    simplified_name: 'Westpoint Induction Cooker',
    description: 'The Westpoint WF-2174 Induction Cooker uses electromagnetic technology to heat only the cooking vessel — not the surface — making it significantly more energy-efficient and safer than conventional hot plates. The glass-ceramic surface stays cool to the touch during cooking, reducing the risk of burns. Precise digital temperature control and a timer function make cooking accurate and consistent. Requires induction-compatible cookware. Available at Reliance Appliances, Karachi.',
    specs: { Type: 'Induction Cooker', Technology: 'Electromagnetic Induction Heating', Surface: 'Cool-Touch Glass-Ceramic Surface', Display: 'Digital Display', Controls: 'Electronic Touch Controls + Timer', Cookware: 'Requires Induction-Compatible (Magnetic) Cookware', 'Energy Efficiency': 'Up to 90% Energy Efficient', 'Power Supply': '220V / 50Hz', Warranty: '1 Year Westpoint Warranty' },
    tags: 'westpoint, WF-2174, induction cooker, induction stove, electric cooker, energy saving, westpoint induction, karachi, installment, reliance appliances',
  },

  // ── Rice Cooker ───────────────────────────────────────────────────────────────
  {
    model: 'WF-2021', mrp: 6800, cat: 'kitchen', sub: 'Rice Cooker',
    simplified_name: 'Westpoint Rice Cooker 1.8L',
    description: 'The Westpoint WF-2021 Rice Cooker takes the guesswork out of cooking perfect rice every time. The automatic cook-and-keep-warm function switches to warming mode as soon as the rice is done, so your meal is always ready when you are. The 1.8-litre non-stick inner pot is easy to clean, and the tempered glass lid lets you monitor cooking without lifting the lid. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-2021, rice cooker, electric rice cooker, 1.8 litre, auto warm, westpoint rice cooker, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-2023', mrp: 7250, cat: 'kitchen', sub: 'Rice Cooker',
    simplified_name: 'Westpoint Rice Cooker with Steamer 2.2L',
    description: 'The Westpoint WF-2023 Rice Cooker with Steamer adds a steam tray above the rice pot, letting you steam vegetables, fish or dumplings while rice cooks below — a complete one-pot meal solution. The 2.2-litre capacity is ideal for families of 4–5. Auto keep-warm keeps food at the perfect temperature until mealtime. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-2023, rice cooker, steamer, 2.2 litre, rice cooker with steamer, westpoint rice cooker, karachi, installment, reliance appliances',
  },

  // ── Vacuum Cleaners ───────────────────────────────────────────────────────────
  {
    model: 'WF-2093', mrp: 18900, cat: 'vacuum', sub: 'Vacuum Cleaner',
    simplified_name: 'Westpoint Vacuum Cleaner',
    description: 'The Westpoint WF-2093 Vacuum Cleaner provides powerful suction for thorough cleaning of carpets, rugs, tiled floors and upholstery. The dust collection bag or container captures fine dust and allergens effectively. Multiple suction settings and a set of attachments handle different surfaces and hard-to-reach areas. Compact and easy to manoeuvre around furniture. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-2093, vacuum cleaner, hoover, dust cleaner, carpet cleaner, westpoint vacuum, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-2097', mrp: 19850, cat: 'vacuum', sub: 'Vacuum Cleaner',
    simplified_name: 'Westpoint Vacuum Cleaner 2-in-1',
    description: 'The Westpoint WF-2097 2-in-1 Vacuum Cleaner converts between a floor vacuum and a handheld unit, giving you flexibility to clean floors, upholstery, car interiors and stairs. The detachable handheld section is lightweight and powerful for targeted cleaning. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-2097, vacuum cleaner, 2 in 1, handheld vacuum, floor vacuum, westpoint vacuum, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-2099', mrp: 25950, cat: 'vacuum', sub: 'Vacuum Cleaner',
    simplified_name: 'Westpoint Vacuum Cleaner 3-in-1',
    description: 'The Westpoint WF-2099 3-in-1 Vacuum Cleaner is a comprehensive cleaning system covering floors, handheld cleaning and blowing functions in a single device. The blower function is ideal for removing dust from keyboards, electronics and garden furniture. Powerful suction and a full attachment set make this the most versatile Westpoint vacuum. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-2099, vacuum cleaner, 3 in 1, blower, handheld, westpoint vacuum, karachi, installment, reliance appliances',
  },

  // ── Fan Heaters ───────────────────────────────────────────────────────────────
  {
    model: 'WF-5014', mrp: 8200, cat: 'small', sub: 'Fan Heater',
    simplified_name: 'Westpoint Ceramic Fan Heater',
    description: 'The Westpoint WF-5014 Ceramic Fan Heater quickly warms small to medium rooms using efficient PTC ceramic heating technology. Ceramic heaters warm up faster and maintain a more stable temperature than traditional coil heaters, with lower fire risk. The built-in fan distributes warm air evenly throughout the room. Available at Reliance Appliances, Karachi.',
  ...
  },
  {
    ...
    tags: 'westpoint, WF-5015, fan heater, ceramic heater, deluxe, room heater, thermostat, westpoint heater, karachi, installment, reliance appliances',
  },
  {
    model: 'WF-5017', mrp: 11000, cat: 'small', sub: 'Fan Heater',
    simplified_name: 'Westpoint Ceramic Fan Heater with Remote',
    description: 'The Westpoint WF-5017 Ceramic Fan Heater with Remote Control lets you adjust heat settings and power the unit on or off from across the room. PTC ceramic technology delivers fast, efficient heating with built-in safety cutoffs. Ideal for bedrooms where you want to control the heater from bed. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, WF-5017, fan heater, ceramic heater, remote control, room heater, westpoint heater, karachi, installment, reliance appliances',
  },
];
