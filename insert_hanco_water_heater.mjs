/**
 * insert_hanco_water_heater.mjs
 * Hanco HEG-50L 50L Solar-Compatible Electric Water Heater
 *
 * Run:  node insert_hanco_water_heater.mjs [--dry-run]
 */
...
Available in Silver and White. Backed by a 2-year leakage warranty from Hanco.`,
  ...
  compatibility_notes:  'Solar-compatible appliance. Designed to run directly off a solar inverter output. Not a solar system component.',
