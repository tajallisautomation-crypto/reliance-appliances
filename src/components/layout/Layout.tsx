...
// Pages that manage their own bottom CTA — hide the global floating WA button there
const HIDE_WA_FLOAT = ['/build-your-package']

export default function Layout({ children }: { children: ReactNode }) {
  const { pathname } = useLocation()
  const showWaFloat = !HIDE_WA_FLOAT.includes(pathname)
