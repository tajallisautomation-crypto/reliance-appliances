...
export const SPEC_SCHEMA: Record<string, SpecField[]> = {
  'Air Conditioners': [
    ...
    { key: 'T3 Rating',          label: 'T3 Tropical Rating (≤52°C ambient)'                      },
  ...
  'Refrigerators': [
    ...
    { key: 'Cooling Type',       label: 'Cooling Type (Direct / No Frost)'                       },
    { key: 'Defrost',            label: 'Defrost Type'                                            },
    { key: 'Glass Shelves',      label: 'Glass Shelves'                                          },
    { key: 'Door Shelves',       label: 'Door Shelves / Pockets'                                 },
    { key: 'Gas Type',           label: 'Refrigerant Gas'                                         },
    { key: 'Energy Class',       label: 'Energy Class'                                            },
    { key: 'Power Consumption',  label: 'Power Consumption',  unit: 'W',    highlight: 'min'      },
  ...
  'Freezer': [
    ...
    { key: 'Energy Class',       label: 'Energy Class'                                            },
    { key: 'Power Consumption',  label: 'Power Consumption',  unit: 'W',    highlight: 'min'      },
    { key: 'Cooling Type',       label: 'Cooling Type'                                            },
  ...
  'Washing Machines': [
    ...
    { key: 'Cloth Capacity',     label: 'Cloth Load Capacity',              highlight: 'max'      },
  ...
  'Televisions': [
    ...
    { key: 'Display Type',       label: 'LED / Display Type (QLED, OLED…)'                       },
    { key: 'Panel Type',         label: 'Panel Technology'                                        },
    { key: 'Display Colors',     label: 'Display Colors (bit depth)'                             },
    { key: 'LED Capabilities',   label: 'LED / Display Capabilities'                             },
    { key: 'Refresh Rate',       label: 'Refresh Rate (Hz)',  unit: 'Hz',   highlight: 'max'      },
    { key: 'HDR Support',        label: 'HDR Support'                                             },
    ...
    { key: 'Dolby',              label: 'Dolby / DTS Audio'                                       },
