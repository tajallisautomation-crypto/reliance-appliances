...
<style>
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .header { display:flex; align-items:flex-start; justify-content:space-between; border-bottom:3px solid #0F2D52; padding-bottom:12px; margin-bottom:18px; }
  .brand-name { font-size:20px; font-weight:900; color:#111; line-height:1; }
  .cat-badge { background:#0F2D52; color:white; padding:6px 14px; border-radius:20px; font-size:13px; font-weight:700; }
  .meta { font-size:10px; color:#999; margin-top:4px; text-align:right; }
  .group { margin-bottom:18px; page-break-inside:avoid; }
  .group-title { font-size:11px; font-weight:700; background:#f3f4f6; border-left:3px solid #0F2D52; padding:5px 10px; margin-bottom:4px; }
  table { width:100%; border-collapse:collapse; }
  thead { background:#0F2D52; color:white; }
  ...
  .footer { margin-top:16px; padding-top:10px; border-top:2px solid #0F2D52; display:flex; justify-content:space-between; font-size:10px; color:#555; }
