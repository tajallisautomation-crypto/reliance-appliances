...
export const ANNUAL_CARE_PLANS: AnnualCarePlan[] = [
  {
    ...
    description: 'Basic preventive service and inspection only. Parts, gas, major repair work, transport and product replacement are not included.',
    appliances: [
      { num: '01', category: 'Air Conditioners',  coverage: '1 visit; cleaning, filter wash, gas pressure & drain check',  startsAt: 7500  },
      { num: '02', category: 'Refrigerators',     coverage: '1 visit; cooling, gasket, leakage & relay check',             startsAt: 6000  },
      { num: '03', category: 'Freezers',          coverage: '1 visit; cooling efficiency, seal & leakage check',           startsAt: 6500  },
      { num: '04', category: 'Washing Machines',  coverage: '1 visit; drain, spin, inlet & performance check',             startsAt: 6000  },
      { num: '05', category: 'Televisions',       coverage: '1 visit; display, ports, sound & basic check',                startsAt: 4500  },
      { num: '06', category: 'Solar & UPS',       coverage: '1 visit; cleaning, wiring, inverter & battery health check',  startsAt: 12000 },
      { num: '07', category: 'Kitchen Appliances',coverage: '1 visit; inspection, cleaning & functional test',             startsAt: 3500  },
      { num: '08', category: 'Water Dispensers',  coverage: '1 visit; tap, tank, cooling/heating & leakage check',         startsAt: 4500  },
      { num: '09', category: 'Small Appliances',  coverage: '1 visit; safety and performance check',                       startsAt: 3000  },
    ],
    includes: [
      '1 scheduled preventive visit per year',
      'Basic inspection and performance check',
      'Basic external cleaning depending on product type',
      '10% off repair labor',
    ...
    terms: [
      'Valid 12 months from activation; price is per registered product or set.',
      'Essential covers preventive care only — parts, gas refill, major repairs, transport and product replacement are not included.',
      "Product eligibility must be confirmed by Tajalli's technical team before activation.",
      "Tajalli's reserves the right to accept, reject, or revise package pricing after inspection.",
      'Damage due to misuse, voltage fluctuation, fire, flooding, pests, rust, theft or accidents is excluded.',
      "Service available within Tajalli's active service areas; out-of-area visits may carry additional charges.",
      'Commercial, industrial, high-use and institutional appliances require separate assessment.',
      'Package is non-transferable; applies only to the registered product at the registered address.',
    ],
  },
  {
    id: 'plus',
    name: 'Plus Care',
    tagline: 'Maintenance + covered parts',
    description: 'Includes Essential benefits, free maintenance labor, and covered parts for eligible faults. Product replacement is not included.',
    appliances: [
      { num: '01', category: 'Air Conditioners',  coverage: '2 visits; maintenance labor & covered parts for eligible faults', startsAt: 16500 },
      { num: '02', category: 'Refrigerators',     coverage: '2 visits; maintenance labor, covered parts & cooling care',       startsAt: 13500 },
      { num: '03', category: 'Freezers',          coverage: '2 visits; maintenance labor, covered parts & seal/cooling care',  startsAt: 14500 },
      { num: '04', category: 'Washing Machines',  coverage: '2 visits; maintenance labor & covered parts',                     startsAt: 13500 },
      { num: '05', category: 'Televisions',       coverage: '2 visits; maintenance labor & covered parts',                     startsAt: 9500  },
      { num: '06', category: 'Solar & UPS',       coverage: '2 visits; maintenance labor, covered parts & system care',        startsAt: 24000 },
      { num: '07', category: 'Kitchen Appliances',coverage: '2 visits; maintenance labor & covered parts',                     startsAt: 7500  },
      { num: '08', category: 'Water Dispensers',  coverage: '2 visits; maintenance labor & covered parts',                     startsAt: 9500  },
      { num: '09', category: 'Small Appliances',  coverage: '2 visits; maintenance labor & covered parts',                     startsAt: 6500  },
    ],
    includes: [
      '2 scheduled service visits per year',
      'Preventive inspection, cleaning & testing',
      'Free maintenance labor for eligible issues',
      'Covered parts for eligible mechanical/electrical faults',
      'Priority response within 48 hours',
      'WhatsApp support + annual service reminder',
    ],
    bestFor: 'Families, offices and businesses that want stronger protection with free maintenance and covered parts, without paying for full-replacement cover.',
    terms: [
      'Valid 12 months from activation; price is per registered product or set.',
      'Plus includes maintenance labor and covered parts for eligible mechanical and electrical faults.',
      'Product replacement is not included under any circumstances.',
      'Damage due to misuse, power surges, fire, flooding, theft, rust, pests, accessories loss or third-party tampering is excluded.',
      "Product eligibility must be confirmed by Tajalli's technical team before activation.",
      "Warranty claims for manufacturer-covered products follow the brand's official warranty process.",
      "Service available within Tajalli's active service areas; out-of-area visits may carry additional charges.",
      'Package is non-transferable; applies only to the registered product at the registered address.',
    ],
  },
  {
    ...
    description: 'Includes Essential + Plus benefits, covered repairs, covered parts, priority handling, and product replacement only if the covered product is declared non-repairable.',
    appliances: [
      { num: '01', category: 'Air Conditioners',  coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 38350 },
      { num: '02', category: 'Refrigerators',     coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 31200 },
      { num: '03', category: 'Freezers',          coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 32500 },
      { num: '04', category: 'Washing Machines',  coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 30550 },
      { num: '05', category: 'Televisions',       coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 24050 },
      { num: '06', category: 'Solar & UPS',       coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 54600 },
      { num: '07', category: 'Kitchen Appliances',coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 17550 },
      { num: '08', category: 'Water Dispensers',  coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 22750 },
      { num: '09', category: 'Small Appliances',  coverage: '3 visits; covered repairs, parts, priority 24hr & replacement if non-repairable', startsAt: 13650 },
    ],
    includes: [
      '3 scheduled service visits per year',
      'Covered repairs for eligible mechanical/electrical faults',
      'Covered parts for eligible faults',
      'Product replacement if declared non-repairable (1 per plan period)',
      'Priority handling within 24 hours',
      'Dedicated WhatsApp support',
    ],
    bestFor: 'Customers who want complete annual protection — covered repairs, parts, and product replacement if their appliance is declared non-repairable.',
    terms: [
      'Valid 12 months from activation; price is per registered product or set.',
      "Elite includes covered repairs, covered parts, and product replacement only if the registered product is declared non-repairable by Tajalli's technical team.",
      'Only 1 product replacement allowed per eligible product per package period.',
      'Replacement will be with an equivalent model, comparable-value product, or available substitute based on stock.',
      'Replacement does not apply to misuse, negligence, voltage surges, fire, water, flood, theft, pests, rust, tampering, unauthorized repair, or accidental breakage.',
      'Replacement does not apply to cosmetic issues, accessories, remotes, consumables, gas refill, installation material, or transport damage.',
      "Product eligibility must be confirmed by Tajalli's technical team before activation.",
      'Package is non-transferable; applies only to the registered product at the registered address.',
    ],
  },
