...
export default function OffGridSolar() {
  return (
    <div className="min-h-screen bg-black text-white">
      <SEO
        path="/solar/off-grid"
        title="Off-Grid Solar Systems Karachi — 100% Power Independence"
        description="Off-grid solar systems for homes and businesses in Karachi. Complete packages with lithium batteries, inverters & tier-1 solar panels. No WAPDA required. Easy installments."
        keywords="off grid solar karachi, off grid solar system pakistan, solar battery backup karachi, 5kw off grid solar, lithium battery solar karachi"
      />
