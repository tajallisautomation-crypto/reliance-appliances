...
export default function Cart() {
  ...
  if (items.length === 0) return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center gap-5 px-4">
      ...
      <Link href="/products" className="bg-brand-500 hover:bg-brand-600 text-white px-8 py-3 rounded-2xl font-semibold transition-colors">
        Browse Products
      </Link>
    </div>
  )
          ...
          <div className="hidden md:block md:col-span-1">
            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm sticky top-24 lg:top-[120px]">
              ...
              <div className="space-y-2">
                <Link href="/checkout" className="flex items-center justify-center gap-2 w-full bg-brand-500 hover:bg-brand-600 text-white py-3 rounded-xl font-semibold">
