...
function ProductComparison() {
  return (<div className="text-center py-8"><Scale className="w-12 h-12 text-gray-300 mx-auto mb-3"/><p className="text-gray-500 mb-4">Compare products side by side from our catalogue.</p><Link href="/products" className="inline-flex items-center gap-2 bg-brand-500 text-white px-6 py-3 rounded-xl font-medium hover:bg-brand-600">Browse Products <ArrowRight className="w-4 h-4"/></Link></div>)
}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mt-6 bg-gradient-to-r from-amber-500 to-orange-500 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-4 text-white">
          ...
          <Link href="/solar-calculator" className="whitespace-nowrap bg-white text-brand-600 px-6 py-3 rounded-xl font-semibold flex items-center gap-2 hover:bg-brand-50">
