  ...
  if (items.length === 0) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/products" className="inline-flex items-center gap-2 bg-brand-500 hover:bg-brand-600 text-white font-bold px-6 py-3 rounded-xl transition-colors">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mt-8 text-center">
        <Link href="/products" className="text-sm text-gray-500 hover:text-brand-600 font-medium transition-colors">
          ← Continue browsing
        </Link>
      </div>
    </div>
