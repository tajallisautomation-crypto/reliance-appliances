              ...
              <div className="text-center py-20 bg-white rounded-2xl border border-gray-100">
                ...
                {searchQuery ? (
                  <>
                    ...
                    <Link href="/products" className="text-gray-400 text-sm hover:underline mt-2 inline-block">
                      Search all products →
                    </Link>
                  </>
                ) : (
                  <>
                    ...
                    <Link href="/products" className="text-brand-500 text-sm hover:underline mt-2 inline-block">
                      Browse all products →
                    </Link>
                  </>
                )}
