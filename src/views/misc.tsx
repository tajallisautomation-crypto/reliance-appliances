...
import ServiceBookingWidget from '@/components/ui/ServiceBookingWidget'
import { CorporateQuoteForm, DownloadCorporateProfile } from '@/components/ui/CorporateQuoteForm'
...
const SERVICE_SCHEMA = {
  ...
  hasOfferCatalog: {
    '@type': 'OfferCatalog',
    name: 'Appliance & Solar Services',
    itemListElement: [
      {
        '@type': 'Offer',
        itemOffered: {
          '@type': 'Service',
          name: 'AC Installation Service in Karachi',
          description: 'Professional split AC installation by certified technicians. Covers bracket fitting, pipe laying, electrical connection and commissioning. 90-day workmanship guarantee.',
          areaServed: { '@type': 'City', name: 'Karachi' },
          provider: { '@type': 'LocalBusiness', name: "Tajalli's Home & Commercial Solutions" },
        },
        price: '3500',
        priceCurrency: 'PKR',
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'AC Repair & Cleaning Service Karachi',
          description: 'AC master service, gas recharge, coil cleaning and fault diagnosis by trained technicians. Same-day service available in Karachi.',
          areaServed: { '@type': 'City', name: 'Karachi' },
          provider: { '@type': 'LocalBusiness', name: "Tajalli's Home & Commercial Solutions" },
        },
        price: '2500',
      ...
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'Solar Panel Installation in Karachi',
          description: 'Complete on-grid and hybrid solar system installation including panels, inverter, battery bank, cabling and commissioning. Free site assessment included.',
          areaServed: { '@type': 'City', name: 'Karachi' },
          provider: { '@type': 'LocalBusiness', name: "Tajalli's Home & Commercial Solutions" },
        },
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'Annual Appliance Maintenance Contract (AMC) Karachi',
          description: 'Annual care plans covering scheduled maintenance visits, priority support, and discounted repair rates for ACs, refrigerators, and other appliances.',
          areaServed: { '@type': 'City', name: 'Karachi' },
          provider: { '@type': 'LocalBusiness', name: "Tajalli's Home & Commercial Solutions" },
        },
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'Refrigerator Repair Service Karachi',
          description: 'Refrigerator and deep freezer repair including compressor service, gas refilling, thermostat and PCB repair. Home visit available.',
          areaServed: { '@type': 'City', name: 'Karachi' },
          provider: { '@type': 'LocalBusiness', name: "Tajalli's Home & Commercial Solutions" },
        },
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'UPS & Battery Backup Installation Karachi',
          description: 'Home and commercial UPS/inverter + lithium or AGM battery installation. Load assessment, wiring and commissioning included.',
          areaServed: { '@type': 'City', name: 'Karachi' },
          provider: { '@type': 'LocalBusiness', name: "Tajalli's Home & Commercial Solutions" },
        },
      },
...
export function Services() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 -mt-6 mb-2 relative z-10">
      ...
      <div className="max-w-5xl mx-auto px-4 py-14 space-y-16">
        ...
        <section className="bg-gray-900 rounded-3xl p-10 text-white text-center">
          ...
          <div className="mt-6 flex flex-wrap gap-4 justify-center text-sm">
            <Link href="/installments" className="text-gray-400 hover:text-white underline">Installment Plans</Link>
            <Link href="/referral" className="text-gray-400 hover:text-white underline">Refer & Earn 2%</Link>
            <Link href="/contact" className="text-gray-400 hover:text-white underline">Get in Touch</Link>
          </div>
        </section>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 py-14 space-y-16">
        ...
        <section>
          <div className="text-center mb-8">
            <h2 className="text-2xl font-black text-gray-900">Request a Commercial Quote</h2>
            <p className="text-gray-500 mt-1 text-sm">Fill in your requirements and we'll send a full itemised proposal within 24 hours.</p>
          </div>
        ...
        <section className="bg-gray-900 rounded-3xl p-8 sm:p-12 text-white">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mt-6 flex flex-wrap gap-4 justify-center text-sm">
              <Link href="/services" className="text-gray-400 hover:text-white underline">After-Sale Services</Link>
              <Link href="/solar" className="text-gray-400 hover:text-white underline">Commercial Solar</Link>
              <Link href="/partner" className="text-gray-400 hover:text-white underline">Become a Partner</Link>
            </div>
          </div>
        </section>
