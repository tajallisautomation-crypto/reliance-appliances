  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        description="Learn about Tajalli's Home & Commercial Solutions — Karachi's trusted appliance partner since 2015. 14,400+ clients served, 24,000+ orders fulfilled, genuine products & real after-sale support."
        ...
        <section className="bg-gray-950 py-14 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-5 text-center sm:hidden">
              <Link href="/gallery" className="text-brand-400 font-semibold text-sm">
                View Full Gallery →
              </Link>
            </div>
          </div>
      ...
      <section className="bg-gray-900 text-white py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/products" className="bg-brand-500 hover:bg-brand-600 text-white font-bold px-8 py-4 rounded-2xl">
              Browse Products
            </Link>
