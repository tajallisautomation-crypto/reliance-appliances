/**
 * insert_westpoint_corrected_D.mjs
 * Hair Dryers, Hair Straighteners, Trimmers, Pop-Up Toasters,
 * Citrus Juicers, Coffee Makers, Insect Killers, Baby Care, Bath Scales
 *
 * Source: Westpoint Price List (Feb-26 / Mar-26)
 * Model format: numeric-only (matching existing Westpoint DB convention)
 *   WF-0811 → 811, WF-0825 → 825, WF-0732 → 732, WF-0775 → 775
 * Price: round(MRP × 1.15 / 100) × 100
 *
 * Run:  node insert_westpoint_corrected_D.mjs [--dry-run]
 */
...
const PRODUCTS = [
  // ── Hair Dryers ───────────────────────────────────────────────────────────────
  { model: '7001', mrp: 3575, cat: 'care', sub: 'Hair Dryer',
    name: 'Westpoint Hair Dryer 1200W',
    desc: 'The Westpoint 7001 Hair Dryer delivers 1200W of drying power for quick, efficient hair drying at home. The lightweight body and ergonomic handle reduce hand fatigue during use. Cold-shot and multiple heat settings let you style as well as dry. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 7001, hair dryer, 1200w, salon dryer, westpoint hair dryer, karachi, installment, reliance appliances' },

  { model: '7002', mrp: 3775, cat: 'care', sub: 'Hair Dryer',
    name: 'Westpoint Hair Dryer 1600W',
    desc: 'The Westpoint 7002 Hair Dryer runs at 1600W for faster drying of thick or long hair. Multiple heat and speed settings give you the control to dry gently or blast through wet hair quickly. The concentrator nozzle focuses airflow for precise styling. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 7002, hair dryer, 1600w, westpoint hair dryer, karachi, installment, reliance appliances' },

  { model: '7007', mrp: 4850, cat: 'care', sub: 'Hair Dryer',
    name: 'Westpoint Ionic Hair Dryer 2200W',
    desc: 'The Westpoint 7007 Ionic Hair Dryer uses negative ion technology to break down water molecules faster, reducing drying time by up to 50% while leaving hair smoother, shinier and frizz-free. The 2200W motor delivers powerful airflow, and the ionic technology counteracts static electricity for salon-quality results at home. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 7007, ionic hair dryer, 2200w, frizz control, salon dryer, westpoint hair dryer, karachi, installment, reliance appliances' },

  { model: '7025', mrp: 5250, cat: 'care', sub: 'Hair Dryer',
    name: 'Westpoint Hair Dryer 2000W',
    desc: 'The Westpoint 7025 Hair Dryer packs a powerful 2000W motor into a sleek, ergonomic body for fast, professional-quality drying. Variable heat and speed settings, a cool-shot button and a removable filter for easy cleaning make this a practical daily-use dryer. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 7025, hair dryer, 2000w, powerful dryer, westpoint hair dryer, karachi, installment, reliance appliances' },

  // ── Hair Straighteners ────────────────────────────────────────────────────────
  { model: '7031', mrp: 3775, cat: 'care', sub: 'Hair Straightener',
    name: 'Westpoint Hair Straightener',
    desc: 'The Westpoint 7031 Hair Straightener delivers sleek, smooth results with floating ceramic plates that adjust to your hair thickness for even heat contact. Quick heat-up time and an adjustable temperature dial suit all hair types from fine to coarse. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 7031, hair straightener, straightener, ceramic plates, westpoint hair, karachi, installment, reliance appliances' },

  { model: '7038', mrp: 5300, cat: 'care', sub: 'Hair Straightener',
    name: 'Westpoint Hair Straightener Curler & Crimper 3-in-1',
    desc: 'The Westpoint 7038 is a versatile 3-in-1 styling tool that straightens, curls and crimps hair with interchangeable plates. Switch from sleek straight hair to defined curls or textured crimped waves — all with one device. Ceramic-coated plates glide smoothly and distribute heat evenly for consistent styling. Available at Reliance Appliances, Karachi.',
  ...
  { model: '7061', mrp: 2550, cat: 'care', sub: 'Trimmer',
    ...
    tags: 'westpoint, 7061, trimmer, beard trimmer, hair trimmer, grooming, westpoint trimmer, karachi, installment, reliance appliances' },

  { model: '7068', mrp: 3600, cat: 'care', sub: 'Trimmer',
    name: 'Westpoint Hair Trimmer Nose Trimmer & Shaver 3-in-1',
    desc: 'The Westpoint 7068 is a complete 3-in-1 grooming kit combining a hair trimmer, nose & ear trimmer and shaver in one device with interchangeable heads. Cover all your grooming needs from one compact appliance. Stainless steel blades, multiple length settings and a compact design make it ideal for daily use and travel. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 7068, trimmer, nose trimmer, shaver, 3 in 1, grooming, westpoint trimmer, karachi, installment, reliance appliances' },

  // ── Pop-Up Toasters ───────────────────────────────────────────────────────────
  { model: '3004', mrp: 6100, cat: 'kitchen', sub: 'Toaster',
    name: 'Westpoint 2 Slice Toaster',
    desc: 'The Westpoint 3004 2-Slice Pop-Up Toaster toasts bread, roti, buns and bagels evenly and quickly. The adjustable browning control lets you set your preferred level from lightly golden to deep brown. The auto-pop mechanism ejects toast at the end of the cycle. The slide-out crumb tray keeps your counter clean. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 3004, toaster, 2 slice toaster, bread toaster, pop up toaster, westpoint toaster, karachi, installment, reliance appliances' },

  { model: '3005', mrp: 8875, cat: 'kitchen', sub: 'Toaster',
    name: 'Westpoint 4 Slice Toaster Full Stainless Steel',
    desc: 'The Westpoint 3005 4-Slice Full Stainless Steel Toaster handles four slices simultaneously — ideal for larger families or busy mornings. The full stainless steel body is durable, easy to clean and gives a premium kitchen aesthetic. Wide slots accommodate thick-cut bread, bagels and artisan loaves. Adjustable browning, reheat, defrost and cancel functions. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 3005, 4 slice toaster, stainless steel toaster, bread toaster, westpoint toaster, karachi, installment, reliance appliances' },

  { model: '3009', mrp: 9800, cat: 'kitchen', sub: 'Toaster',
    name: 'Westpoint 4 Slice Toaster',
    desc: 'The Westpoint 3009 4-Slice Pop-Up Toaster toasts four slices at once with even, consistent browning. Perfect for families who want breakfast on the table quickly. Wide slots, adjustable browning control, cancel button and a removable crumb tray for easy cleaning. Available at Reliance Appliances, Karachi.',
  ...
  { model: '2158', mrp: 6900, cat: 'kitchen', sub: 'Citrus Juicer',
    ...
    tags: 'westpoint, 2158, citrus juicer, deluxe, orange juicer, grapefruit juicer, westpoint juicer, karachi, installment, reliance appliances' },

  // ── Coffee Makers ─────────────────────────────────────────────────────────────
  { model: '811', mrp: 8500, cat: 'kitchen', sub: 'Coffee Maker',
    name: 'Westpoint Coffee Maker',
    desc: 'The Westpoint 811 Drip Coffee Maker brews fresh, aromatic coffee in minutes. The pause-and-pour function lets you pour a cup mid-brew without mess. The keep-warm plate maintains your coffee at the perfect drinking temperature. Compatible with ground coffee and paper filters. Ideal for households that start their day with freshly brewed coffee. Available at Reliance Appliances, Karachi.',
  ...
  { model: '825', mrp: 17850, cat: 'kitchen', sub: 'Coffee Maker',
    ...
    tags: 'westpoint, 825, espresso machine, coffee maker, cappuccino, latte, steam wand, westpoint coffee, karachi, installment, reliance appliances' },

  // ── Insect Killers ────────────────────────────────────────────────────────────
  { model: '1086', mrp: 8750, cat: 'small', sub: 'Insect Killer',
    name: 'Westpoint Insect Killer',
    desc: 'The Westpoint 1086 Electric Insect Killer uses UV light to attract mosquitoes, flies and other flying insects, then eliminates them with a high-voltage electric grid — no chemicals, no sprays. The removable collection tray is easy to clean. Safe and effective for homes, offices and outdoor areas. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 1086, insect killer, mosquito killer, fly killer, bug zapper, westpoint insect killer, karachi, installment, reliance appliances' },

  { model: '1089', mrp: 11900, cat: 'small', sub: 'Insect Killer',
    name: 'Westpoint Insect Killer Large',
    desc: 'The Westpoint 1089 Large Electric Insect Killer covers a larger area with higher-power UV tubes that attract insects from a greater distance. The heavy-duty electric grid eliminates insects instantly. The reinforced safety cage and stable base make it suitable for restaurants, large rooms and covered outdoor spaces. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 1089, insect killer, large insect killer, mosquito killer, fly killer, restaurant, westpoint insect killer, karachi, installment, reliance appliances' },

  // ── Baby Care ─────────────────────────────────────────────────────────────────
  { model: '732', mrp: 3925, cat: 'small', sub: 'Baby Care',
    name: 'Westpoint Baby Bottle Warmer',
    desc: 'The Westpoint 732 Baby Bottle Warmer gently and evenly warms infant formula and breast milk to a safe, consistent temperature. Unlike microwave heating, the warmer heats gradually from outside to prevent dangerous hot spots in the milk. Compatible with most standard and wide-neck bottles. An essential appliance for new parents. Available at Reliance Appliances, Karachi.',
  ...
  { model: '775', mrp: 5100, cat: 'small', sub: 'Baby Care',
    ...
    tags: 'westpoint, 775, egg boiler, electric egg boiler, egg cooker, westpoint egg boiler, karachi, installment, reliance appliances' },

  // ── Bath Scales ───────────────────────────────────────────────────────────────
  { model: '8026', mrp: 3850, cat: 'care', sub: 'Bath Scale',
    name: 'Westpoint Digital Bath Scale',
    desc: 'The Westpoint 8026 Digital Bath Scale provides accurate, instant weight readings on a clear LCD display. The tempered glass platform is sleek, durable and easy to clean. Auto-on and auto-off functions conserve battery. A simple, reliable health monitoring tool for the bathroom. Available at Reliance Appliances, Karachi.',
    ...
    tags: 'westpoint, 8026, digital scale, bathroom scale, weight scale, health scale, westpoint scale, karachi, installment, reliance appliances' },
];
